class_name _MMFileWriterTestFilepaths
...
static func for_loaders(root: String) -> _MMFileWriterTestFilepaths:
	return _MMFileWriterTestFilepaths.new(root, true)

static func for_savers(root: String) -> _MMFileWriterTestFilepaths:
	return _MMFileWriterTestFilepaths.new(root, false)
...
func object() -> String:
	return MMPathLib.join(_root, "object.gd")
...
func _get_test_object_filepath(is_expected: bool) -> String:
	...
	return MMPathLib.join(_root, filename)
