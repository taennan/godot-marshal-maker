	...
	func test_it_infers_single_types():
		...
		for op in assignment_ops:
			for data in test_data:
				...
				var tokens := MMFieldTokens.new(text)
				assert_false(tokens.error())
