...
func test_it_writes_primitive_fields_correctly():
	...
	var expected_filepath := "res://addons/auto_serde_tests/file_writers/primitives/expected_loader.gd"
	var actual_filepath := "res://addons/auto_serde_tests/file_writers/primitives/actual_loader.txt"
...
func test_it_writes_renamed_fields_correctly():
	...
	var expected_filepath := "res://addons/auto_serde_tests/file_writers/rename/expected_loader.gd"
	var actual_filepath := "res://addons/auto_serde_tests/file_writers/rename/actual_loader.txt"
	_run_test(object_filepath, actual_filepath, expected_filepath)
...
func test_it_writes_ignored_and_included_fields_correctly():
	...
	var expected_filepath := "res://addons/auto_serde_tests/file_writers/ignore_include/expected_loader.gd"
	var actual_filepath := "res://addons/auto_serde_tests/file_writers/ignore_include/actual_loader.txt"
	_run_test(object_filepath, actual_filepath, expected_filepath)
...
func test_it_writes_serde_object_fields_correctly():
	...
	var expected_filepath := "res://addons/auto_serde_tests/file_writers/serde_objects/expected_loader.gd"
	var actual_filepath := "res://addons/auto_serde_tests/file_writers/serde_objects/actual_loader.txt"
	_run_test(object_filepath, actual_filepath, expected_filepath)
